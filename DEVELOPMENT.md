...
1. 학교급, 교과군, 과목을 선택합니다.
2. 선택한 과목의 교육과정 주제 한 개를 무작위로 뽑습니다.
...
231과목을 포함하고, 직업계 전문교과는 기본 선택 목록에서 제외합니다.
...
물리학은 기존 수업 흐름을 보존하기 위해 위 15개 세부 키워드를 별도로 유지합니다. 그 외
과목은 원본 데이터의 짧은 영역명을 발표 주제로 사용하며, 공통 설명 질문과 핵심어를 붙입니다.
...
생성 파일은 직접 편집하지 않습니다. 물리학 전용 세부 키워드는 `app/page.tsx`의
`PHYSICS_KEYWORDS`에서 관리합니다.
...
- 중학교 24과목, 고등학교 비직업계 231과목 선택 기능 추가
